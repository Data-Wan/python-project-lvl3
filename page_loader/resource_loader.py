...
from page_loader.fs_modul import write_image, write_resource
...
def download_source_tag(  # noqa: WPS231, WPS210, E501
    all_files_path, url, resources, source_tag,
):
    ...
    for resource_tag in resources:
        ...
        if (get_netloc(source) != get_netloc(url)) and get_netloc(source):
